"""Web search tool -- Exa primary for artist research."""
...
class SearchArgs(BaseModel):
    query: str = Field(description="Natural-language web search query about an artist, artwork, or art market.")
...
web_search = StructuredTool.from_function(
    ...
    name="web_search",
    description=(
        "Search the web for information about artists, artworks, exhibitions, "
        "auction results, art market news, and gallery events. "
